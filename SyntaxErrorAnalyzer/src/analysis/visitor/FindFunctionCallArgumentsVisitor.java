...
public class FindFunctionCallArgumentsVisitor implements Visitor {

	private List<Node> functionCallArguments = new ArrayList<Node>();

	public List<Node> getFunctionCallArguments() {
	...
	public void run(ExprList node) {
		if ((node.getParent() != null)
				&& (node.getParent() instanceof tree.FunctionCall)
				&&(node.getChildren() != null)) {
			
			functionCallArguments.addAll(node.getChildren());
		}
