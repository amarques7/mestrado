...
public class FindFunctionCallVariablesVisitor implements Visitor {

	private List<Id> variables = new ArrayList<Id>();
	private boolean firstExprList = true;
	...
	public boolean isFirstExprList() {
		return firstExprList;
	}
	
	public void setFirstExprList(boolean firstExprList) {
		this.firstExprList = firstExprList;
	}
	...
	public FindFunctionCallVariablesVisitor(int position) {
		this.position = position;
	}
