...
public class FindVariableDeclarationInsideFunctionVisitor implements Visitor {

	private Set<Id> localVariables = new HashSet<Id>();
	private Set<String> localVariablesNames = new HashSet<String>();
	
	public Set<Id> getLocalVariables() {
		return localVariables;
	}
	
	public Set<String> getLocalVariablesNames() {
		return localVariablesNames;
	}
	
	public FindVariableDeclarationInsideFunctionVisitor() {
	}
	...
	public void run(InitDeclaratorI node) {
		if ((node.getChildren().size() > 0)
				...
				if (node.getChildren().get(0).getChildren().get(0) instanceof Id) {
					this.localVariables.add((Id) node.getChildren().get(0).getChildren().get(0));
					this.localVariablesNames.add(((Id) node.getChildren().get(0).getChildren().get(0)).getName());
				} else if ((node.getChildren().get(0).getChildren().size() > 1) && (node.getChildren().get(0).getChildren().get(1) instanceof Id)) {
					this.localVariables.add((Id) node.getChildren().get(0).getChildren().get(1));
					this.localVariablesNames.add(((Id) node.getChildren().get(0).getChildren().get(1)).getName());
				} else if ((node.getChildren().get(0).getChildren().size() > 2) && (node.getChildren().get(0).getChildren().get(2) instanceof Id)) {
					this.localVariables.add((Id) node.getChildren().get(0).getChildren().get(2));
					this.localVariablesNames.add(((Id) node.getChildren().get(0).getChildren().get(2)).getName());
				} 
		}
		for (int i = 0; i < node.getChildren().size(); i++) {
			node.getChildren().get(i).accept(this);
