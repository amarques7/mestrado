...
public class ASTGenerator {
	...
	// This method receives the translation units from TypeChef and my Translation
	...
	public void generate(Product node, Node parent) throws Exception {
		try {
			...
			System.out.println("erro 101 ASTGenerator: "+ e);
			e.printStackTrace();
	...
	public Node getNode(Product node) {
		...
		if (node instanceof de.fosd.typechef.parser.c.CompoundStatement) {
			...
			try {
				// Second Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) node.productElement(0)).productElement(1))
						.productElement(0);
				lit.setText(opt.productElement(1).toString());
			...
			try {
				// Third Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) ((Product) node.productElement(0)).productElement(1))
						.productElement(1)).productElement(0);
				lit.setText(opt.productElement(1).toString());
			...
			try {
				// Fourth Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) ((Product) ((Product) node.productElement(0))
						.productElement(1)).productElement(1)).productElement(1)).productElement(0);
				lit.setText(opt.productElement(1).toString());
			...
			try {
				// Fifth Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) ((Product) ((Product) ((Product) node.productElement(0))
						.productElement(1)).productElement(1)).productElement(1)).productElement(1)).productElement(0);
				lit.setText(opt.productElement(1).toString());
			...
			try {
				// Sixth Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) ((Product) ((Product) ((Product) ((Product) node
						.productElement(0)).productElement(1)).productElement(1)).productElement(1)).productElement(1))
								.productElement(1)).productElement(0);
				lit.setText(opt.productElement(1).toString());
			...
			try {
				// Seventh Opt
				StringLit lit = new StringLit();
				Opt<?> opt = (Opt<?>) ((Product) ((Product) ((Product) ((Product) ((Product) ((Product) ((Product) node
						.productElement(0)).productElement(1)).productElement(1)).productElement(1)).productElement(1))
								.productElement(1)).productElement(1)).productElement(0);
				lit.setText(opt.productElement(1).toString());
